...
Его синтаксис аналогичен синтаксису индексации, но вместо одного индекса вы используете
два индекса (целых числа), разделенных двоеточием.
Например, str[2:5]
"""
...
python = monty_python[6:12]		# Используйте оператор среза для получения подстроки “Python”
print(python)
